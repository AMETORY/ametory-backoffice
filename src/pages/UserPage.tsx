...
import { getUsers, inviteUser, updateUser } from "../services/api/userApi";
...
const UserPage: FC<UserPageProps> = ({}) => {
  ...
  const getAllCategories = (s: string = "") => {
    getUsers({ page: search ? 1 : page, size, search: s })
      .then((resp: any) => {
  ...
  return (
    <TableLayout
      ...
      setPage={setPage}
      setSize={setSize}
      tableHeader={["Nama", "Email", "Telp", "Status"]}
